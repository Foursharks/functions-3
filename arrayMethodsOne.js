...
// // CODE HERE
const postTaxPrices = prices.map((num) => num *7/100)
...
// // CODE HERE
const myStrongest  = monstersInYourPocket.filter((val, index) => val.CP > 200)
...
// // CODE HERE
const orderTotals = orders.map((order) => order.price *order.tax + order.price)
...
const bobTotal = bobPurchases.reduce(((runningTotal, curr)  => runningTotal + curr.price), 0)
