...
// CODE HERE
const numbersDivide = numbers.map((num)=> num/2)
...
// CODE HERE
const newCities = cities.filter((num) => num[num.length-1] ==='i'); // Tokyo[4]
...
// CODE HERE
const totalFoods = foods.filter((tag) => tag.tags.includes("rice")).reduce(((runningTotal, curr)  => runningTotal + curr.price), 0)
